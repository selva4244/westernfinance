...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=westernfinance_db;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/westernfinance/';
    $fsitename = 'http://localhost/westernfinance/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOT', $fsitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/westernfinance/";
    ...
    $db = new PDO('mysql:host=localhost;dbname=annamalaiyar;charset=utf8mb4', 'annamalaiyar', 'annamalaiyar');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "annamalaiyar", "annamalaiyar", "annamalaiyar");
    $sitename = "https://ttbilling.in/westernfinance/";
    $site = 'https://ttbilling.in/westernfinance/';
    $fsitename = 'https://ttbilling.in/westernfinance/';
