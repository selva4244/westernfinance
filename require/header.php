...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Annamalaiyar Finance Admin Control</title>
    ...
    <body class="skin-blue sidebar-mini skin-blue sidebar-mini <?php echo $collapse; ?>" onload="startTime();">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo $sitename; ?>" class="logo" style="background-color: #008d4c;">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>AF</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Annamalaiyar Finance</b></span>
                </a>
                <!-- Header Navbar: style can be found in header.less -->
                <nav class="navbar navbar-static-top" role="navigation" style="background-color: #008d4c;">
