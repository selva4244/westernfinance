...
$msg = addcustomer($cusid,$date,$receipt_no,$name,$mobileno,$image,$address,$object1,$object_image1,$idproof,$proofname1,$proof1,$quantity1,$netweight,$amount,$interestpercent,$interest,$status,$ip, $getid);
}
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                            ...
                            <input type="text"  required="required" name="mobileno" id="mobileno" placeholder="Enter Mobile Number" class="form-control" value="<?php echo stripslashes(getcustomer('mobileno',$_REQUEST['cid'])); ?>" />
                        </div>
                        <div class="col-md-4">
