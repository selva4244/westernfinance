...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Object
            <small>List of Silver Object(s)</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>pages/process/addobject.htm">Add New Silver Object</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>process/' + a + '/editobject.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        "searching": true,
	"ordering":false,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=silverobjecttable"
    });
</script>