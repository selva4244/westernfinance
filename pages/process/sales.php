...
<script type="text/javascript" >
...

    {
...

        {
            ...
            if (confirm("Please confirm you want to Delete this Sale(s)"))
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header">
                ...
                <h3 class="box-title"><a href="<?php echo $sitename; ?>pages/process/addsales.htm">Add New Sales</a></h3>
                <?php 
                 $sql4 = $db->prepare("SELECT * FROM `sales` WHERE `status`=1  ");
                 $sql4->execute();
                 $tot = 0;
                 while ($purchase = $sql4->fetch(PDO::FETCH_ASSOC)) 
                {
                 ...
                 ?>
                <h3>TOTAL SALES AMOUNT:<?php echo $tot; ?></h3>
