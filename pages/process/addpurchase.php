...
// $quantity11 = ltrim($quantity1, ',');
    $msg = addpurchase($supplierid, $date, $netweight, $amount, $status,$object1, $quantity1, $getid);
}
        ...
        <form name="department" id="department"  method="post" enctype="multipart/form-data">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label>Supplier ID <span style="color:#FF0000;">*</span><a href="<?php $fsitename; ?>addsupplier.htm"> Add Supplier </a></label>
