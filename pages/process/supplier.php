    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header">
                ...
                <h3 class="box-title"><a href="<?php echo $sitename; ?>pages/process/addsupplier.htm">Add New Supplier</a></h3>
...
<script type="text/javascript">
...

    {
        ...
        window.location.href = '<?php echo $sitename; ?>process/' + a + '/editsupplier.htm';
...
<script type="text/javascript">
    ...
    $('#normalexamples').dataTable({
        ...
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=suppliertable",
