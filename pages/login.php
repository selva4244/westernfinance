...
<html lang="en-IN">
    <head>
        <meta charset="UTF-8">
        <title>Annamalaiyar Finance | Login</title>
    ...
    <body class="login-page  ">
        <div class="login-box ">
            <div class="login-logo">
                <img src="loginimg.jpg" style="width:50%;height:50%"/>
                <a href="#"><h3>Annamalaiyar Finance<!-- <img src="<?php echo $sitename; ?>pages/profile/image/1532344513.png" /> --></h3></a>
            </div><!-- /.login-logo -->
